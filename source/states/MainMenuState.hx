...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var menuOptionConfig = JsonModLoader.loadStateJson("Menu", "MenuOptions");

		// massive if statement block incoming!

		if(menuOptionConfig.IncludeStoryMode == "true")
		{
			optionShit.push('story_mode');
		}
		if(menuOptionConfig.IncludeFreeplay == "true")
		{
			optionShit.push('freeplay');
		}
		#if MODS_ALLOWED
		if(menuOptionConfig.IncludeMods == "true")
		{
			optionShit.push('mods');
		}
		#end
		#if ACHIEVEMENTS_ALLOWED
		if(menuOptionConfig.IncludeAwards == "true")
		{
			optionShit.push('awards');
		}
		#end
		if(menuOptionConfig.IncludeCredits == "true")
		{
			optionShit.push('credits');
		}
		if(menuOptionConfig.IncludeDonos == "true")
		{
			optionShit.push('donate');
		}
		if(menuOptionConfig.IncludeOptions == "true")
		{
		...
		var menuConfig = JsonModLoader.loadStateJson("Menu", "MenuState");
		...
		var psychVer:FlxText = new FlxText(12, FlxG.height - 44, 0, engineName + "v" + engineVer, 12);
		psychVer.scrollFactor.set();
		psychVer.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(psychVer);
		var fnfVer:FlxText = new FlxText(12, FlxG.height - 24, 0, "Press 'Q' to quit, also fnf ver: 0.2.8", 12);
