...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		var introTextConfig = JsonModLoader.loadStateJson("Intro", "IntroText");
		var creator:String = introTextConfig.Creator;
		var credit:String = introTextConfig.Credit;
		var modNameConfig = JsonModLoader.loadStateJson("Intro", "ModName");
		var modLineOne:String = modNameConfig.LineOne;
		var modLineTwo:String = modNameConfig.LineTwo;
		var modLineThree:String = modNameConfig.LineThree;
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText([creator + ' Presents'], 40);
					#else
					createCoolText(['ninjamuffin99', 'phantomArcade', 'kawaisprite', 'evilsk8er']);
					#end
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('Built with:', 40);
					addMoreText(credit, 40);
					#else
					addMoreText('present');
					#end
				case 5:
				...
				case 13:
					deleteCoolText();
				case 14:
					addMoreText(modLineOne);
				case 15:
					addMoreText(modLineTwo);
				case 16:
					addMoreText(modLineThree); // credTextShit.text += '\nFunkin';
